...
/**
 * This class will allow the user build a gridpane where the user can input the
 * students ID and a window will show up with the student information in it
 * 
 * @author Caio
 *
 */
public class FindStudentPane {
	...
	/**
	 * Constructor that will build a grid pane that allows user to put in Id and
	 * then display a TableView With that students particular Information.
	 */
